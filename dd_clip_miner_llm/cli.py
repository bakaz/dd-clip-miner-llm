...
def _generate_config_yaml() -> str:
    lines = [
        ...
        "  channels: 1",
        "",
        "# ASR: 默认 qwen3_asr；GPU=Qwen3+FW turbo / CPU=SenseVoice+FW small",
        "asr:",
        "  mode: local",
        "  local:",
        "    backend: qwen3_asr",
        ...
        "      - song",
        "",
        "# cut-copy 工作流（录播自动处理，详情见 cut_copy.example.conf）",
        "cut_copy:",
        "  enabled: false",
