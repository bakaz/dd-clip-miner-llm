...
def test_load_cut_copy_example_path():
    ...
    assert cfg["processing"]["config_path"] == "config.yaml"


def test_load_cut_copy_default_resolution_finds_example():
    """No path argument → resolves to config/example/cut_copy.yaml as fallback."""
